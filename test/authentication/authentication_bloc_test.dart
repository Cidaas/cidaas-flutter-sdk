...
const String testToken = 'ey..h';
...
void main() {
  ...
  group('authenticationBloc tests with mocked secure storage, user not logged in:', () {
    ...
    setUp(() {
      ...
      tokenEntity = TokenEntity(accessToken: 'accessToken', idToken: 'idToken', sub: 'sub', refreshToken: 'refreshToken');
    });
