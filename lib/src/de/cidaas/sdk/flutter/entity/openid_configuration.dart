...
class OpenIdConfiguration {
  ...
  OpenIdConfiguration.fromJson(Map<String, dynamic> json)
      : issuer = json['issuer'],
        ...
        introspectionAsyncUpdateEndpoint =
            json['introspection_async_update_endpoint'],
        ...
        tokenEndpointAuthSigningAlgValuesSupported =
            (json['token_endpoint_auth_signing_alg_values_supported']
                ...
                .cast<String>(),
        claimsSupported =
            (json['claims_supported'] as List<dynamic>).cast<String>(),
        claimsParameterSupported = json['claims_parameter_supported'],
        claimsTypesSupported =
            (json['claim_types_supported'] as List<dynamic>).cast<String>(),
        serviceDocumentation = json['service_documentation'],
        uiLocalesSupported =
            (json['ui_locales_supported'] as List<dynamic>).cast<String>(),
        displayValuesSupported =
            (json['display_values_supported'] as List<dynamic>).cast<String>(),
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
        ...
        'social_provider_token_resolver_endpoint':
            socialProviderTokenResolverEndpoint,
